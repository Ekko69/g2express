...
class NewTaxiOrderLocationEntryViewModel extends MyBaseViewModel {
  ...
  onAddressSelected(Address address) async {
    ...
    try {
      taxiViewModel.deliveryAddress = new DeliveryAddress();
      taxiViewModel.deliveryAddress.address = address.addressLine;
      taxiViewModel.deliveryAddress.latitude = address.coordinates.latitude;
      taxiViewModel.deliveryAddress.longitude = address.coordinates.longitude;
      taxiViewModel.checkout.deliveryAddress = taxiViewModel.deliveryAddress;
